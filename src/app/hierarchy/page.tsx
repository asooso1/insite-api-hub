...
import { Users, Folder, Database, ChevronRight, LayoutGrid, Network, Share2, GitBranch } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { Team, getTeams, getProjectsByTeam } from "@/app/actions/team";
                            ...
                            teams.map(team => (
                                <div key={team.id} className="relative">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ml-10 border-l-2 border-border pl-10">
                                        {/* Mocking linked projects for now - need real mapping in final */}
